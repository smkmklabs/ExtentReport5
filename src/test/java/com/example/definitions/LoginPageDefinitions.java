...
public class LoginPageDefinitions {
    ...
    public void verifyLogin() {
        ...
        // Verify home page
        assertTrue(objHomePage.getHomePageText().contains("Dashboard"));
    ...
    public void verifyErrorMessage(String expectedErrorMessage) {
        ...
        // Verify home page
        assertEquals(objLogin.getErrorMessage(),expectedErrorMessage);
    ...
    public void verifyMissingUsernameMessage(String message) {
        ...
        assertEquals(objLogin.getMissingUsernameText(),message);
    }
     
    @Then("User should be able to see LinkedIn Icon")
    public void verifyLinkedInIcon( ) {
         
        assertTrue(objLogin.getLinkedInIcon());
    }
     
    @Then("User should be able to see FaceBook Icon")
    public void verifyFaceBookIcon( ) {
         
        assertTrue(objLogin.getFaceBookIcon());
    }
     
    @Then("User should navigate to a new page")
    public void verfiyForgetYourPasswordPage() {
         
        assertEquals(objForgotPasswordPage.getForgotPasswordPageText(), "Reset Password");
    }
